...
const projects = [
  ...
  },
  {
    ...
    description: "An end-to-end process shipping platform",
  ...
  {
    title: "HRIS with Timekeeping Service",
    description: "A full feature payroll management, employee information, timekeeping up to employee portal",
    image: "/images/placeholder.webp?height=300&width=500",
    large: true,
    links: {
      demo: "https://example.com",
  ...
  {
    title: "Raffle System",
    description: "A very simple raffle system",
    image: "/images/placeholder.webp?height=400&width=600",
    links: {
      demo: "https://example.com",
      github: "https://github.com",
